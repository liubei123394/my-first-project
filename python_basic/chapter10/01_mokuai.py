...
#模块的分类:
#Pythan 中的模块分为三类，分别是:标准库模块、自定义模块、第三方模块。
...
#from pay impart timeout as tm, show_info as show2
#print(max_amt)
#print(tm)
#show1()
#show2( )
...
#关于__all__
#在 Python 模块中,可通过__all__来控制【from 模块 import*】能导入哪些内容.
#·__all__的值可以是:列表、元组。


#关于 __name__
#__name__ 是每个 Python 模块(.py文件)都拥有的一个内置变量。
#它的具体值取决于模块的运行方式:
