...
# hobby 是列表，并且列表中的元素，可以是:str或int 类型
...
#scores是元组，并且元组中包含任意个数的元素，每个元素的类型可以是：int或str
scores: tuple[int | str, ...]=(60, '70', 80, '90', 100)

#python会根据初始赋值推到变量的类型
